      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {currentJobs.map((job) => (
          <div key={job._id} className="bg-gray-50 rounded-lg p-6 relative">
            ...
            <button className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-green-300 hover:text-black transition" onClick={() => navigate('/candidateUpload')}>Smart Recruit</button>
          </div>
        ))}
